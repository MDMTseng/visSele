...
using namespace std;
class InspectionTarget_Empty :public InspectionTarget
{
...
public:
  ...
  virtual cJSON* genITIOInfo()
  {
    ...
    {
      cJSON_AddItemToObject(info, "io",genIOInfo({StageInfo_Orientation::stypeName()},{StageInfo_Empty::stypeName()}) );
    }
    return info;
  }
  ...
  virtual ~InspectionTarget_Empty();
