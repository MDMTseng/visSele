...
class InspectionTarget_ArcFitting :public InspectionTarget
{
...
public:
  ...
  virtual cJSON* genITIOInfo()
  {
    ...
    {
      cJSON_AddItemToObject(info, "io",genIOInfo({StageInfo_Image::stypeName()},{StageInfo_ArcFitting::stypeName()}) );
    }
    return info;
  }
  ...
  virtual ~InspectionTarget_ArcFitting();
