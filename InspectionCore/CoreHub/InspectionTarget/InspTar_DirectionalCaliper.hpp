...
class InspectionTarget_DirectionalCaliper :public InspectionTarget
{
...
public:
  ...
  virtual cJSON* genITIOInfo()
  {
    ...
    {
      cJSON_AddItemToObject(info, "io",genIOInfo({StageInfo_Image::stypeName()},{StageInfo_DirectionalCaliper::stypeName()}) );
    }
    return info;
  }
  ...
  virtual ~InspectionTarget_DirectionalCaliper();
