...
#define LOGI(fmt,...) logi("%s%04d %s:i " fmt __BR__,_SubString_Align(__FILENAME__,LOG_FILENAME_L),__LINE__,__func__ VA_ARGS(__VA_ARGS__))
#define LOGE(fmt,...) loge("%s%04d %s:e " fmt __BR__,_SubString_Align(__FILENAME__,LOG_FILENAME_L),__LINE__,__func__ VA_ARGS(__VA_ARGS__))
