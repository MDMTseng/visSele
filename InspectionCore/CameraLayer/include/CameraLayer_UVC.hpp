#ifndef CAMERALAYER_UVC_HPP
#define CAMERALAYER_UVC_HPP
#ifdef __WIN32__
#include <windows.h>
#endif
...
protected:
  ...
  // static void s_STREAM_NEW_BUFFER_CB(ArvStream *stream, CameraLayer_UVC *self);
  // void STREAM_NEW_BUFFER_CB(ArvStream *stream);
  // static void s_STREAM_CONTROL_LOST_CB(ArvStream *stream, CameraLayer_UVC *self);
...
public:
  ...
  // CameraLayer_UVC(const char* deviceID,CameraLayer_Callback cb, void *context);
  CameraLayer_UVC(CameraLayer::BasicCameraInfo camInfo,std::string misc,CameraLayer_Callback cb,void* context);
