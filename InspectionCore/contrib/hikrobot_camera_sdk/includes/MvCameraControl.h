 ...
 *  @remarks 获取最佳的packet size，对应GigEVision设备是SCPS。
			 ...
			 该接口仅支持自研网卡设备，不支持其他GenTL设备（协议不支持）,如果是GenTL方式添加的网口相机，建议根据网络实际情况配置GevSCPSPacketSize，或者配置1500。
 ...
 *  @remarks To get optimized packet size, for GigEVision device is SCPS, for USB3Vision device is the size of packet read from drive each time, 
			 ...
			 This interface does not support other GenTL devices (protocol not supported). If a network camera is added in GenTL mode, it is recommended to configure GevSCPSPacketSize according to the actual network situation,or 1500.
 ************************************************************************/
