...
arv_debug_level_get_type (void)
{
  ...
  static const GEnumValue values[] = {
    ...
    { C_ENUM(ARV_DEBUG_LEVEL_LOG), "ARV_DEBUG_LEVEL_LOG", "log" },
    { C_ENUM(ARV_DEBUG_LEVEL_VERBOSE_LOG), "ARV_DEBUG_LEVEL_VERBOSE_LOG", "verbose-log" },
    { C_ENUM(ARV_DEBUG_LEVEL_COUNT), "ARV_DEBUG_LEVEL_COUNT", "count" },
    { 0, NULL, NULL }
  };
...
arv_gvcp_error_get_type (void)
{
  ...
  static const GEnumValue values[] = {
    ...
    { C_ENUM(ARV_GVCP_ERROR_PACKET__REMOVED_FROM_MEMORY), "ARV_GVCP_ERROR_PACKET__REMOVED_FROM_MEMORY", "packet--removed-from-memory" },
