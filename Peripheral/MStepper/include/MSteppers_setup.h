...
#define PIN_Z1_SEN2 (4+EXT_IO_AXIS_SENSOR_BASE)
#define PIN_Z2_SEN2 (5+EXT_IO_AXIS_SENSOR_BASE)
#define PIN_Z3_SEN2 (6+EXT_IO_AXIS_SENSOR_BASE)
#define PIN_Z4_SEN2 (7+EXT_IO_AXIS_SENSOR_BASE)
