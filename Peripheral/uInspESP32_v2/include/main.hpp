...
// RESET_GateSensing function removed - now using GateSensor class
...
// Include Diagnostics after GEN_ERROR_CODE is defined
...
// PIPE_INFO_LEN removed - now using PIPELINE_CAPACITY from Pipeline.hpp
