// GENERATED for long bench runs -- do not ship. Identical to
// vite.config.prod.mjs except __DEV_MODE__ stays true (the webctl harness
// drives the page through window.__GP_STORE__, which production strips) and
// the output goes to dist-soak so it cannot be confused with a real build.
